...
<body>
	...
	<div class="plans mc-plans py-5">
		<div class="container">
            ...
            <?php 
    $ddos_protection = [
        'name' => 'Thunder Nodes DDoS Protection Shield',
        'features' => [
            'Full DDoS Protection – Guard your server against attacks.',
            '24/7 Monitoring – Always on the lookout for threats.',
            'Easy Setup – Get protected without the hassle.',
            'Global Coverage – Securing your server anytime, anywhere.'
        ],
        'price' => '₹800'
    ];
?>
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6">
            <div class="card text-center">
                <div class="card-body">
                    <h2><?= $ddos_protection['name'] ?></h2>
                    <ul>
                        <?php foreach ($ddos_protection['features'] as $feature) : ?>
                            <li><?= $feature ?></li>
                        <?php endforeach; ?>
                        <li><strong>Price:</strong> <?= $ddos_protection['price'] ?></li>
                    </ul>
