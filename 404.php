...
<body>
    ...
    <div class="py-6 error">
    <div class="container text-center py-5">
        <h1 class="display-4 text-white fw-bolder">COMING SOON</h1>
        <p class="lead">"Stay Tuned! We’re Launching Soon."</p>
        <a href="index" class="btn btn-primary">Return to Home</a>
    </div></div>
