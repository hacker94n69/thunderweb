...
<body>
	...
	<div class="plans mc-plans py-5">
		<div class="container">
            ...
            <?php 
    $domains = [
        ['extension' => '.fun', 'price' => '₹200'],
        ['extension' => '.tech', 'price' => '₹250'],
        ['extension' => '.online', 'price' => '₹250'],
        ['extension' => '.xyz', 'price' => '₹290'],
        ['extension' => '.com', 'price' => '₹1,200'],
        ['extension' => '.in', 'price' => '₹1,100'],
        ['extension' => '.net', 'price' => '₹1,600'],
        ['extension' => '.org', 'price' => '₹1,000'],
        ['extension' => '.shop', 'price' => '₹200'],
        ['extension' => '.store', 'price' => '₹225'],
        ['extension' => '.site', 'price' => '₹200']
    ];
?>
                ...
                <div class="card-body">
                    ...
                    <ul>
                        <?php foreach ($domains as $domain) : ?>
                            <li><strong><?= $domain['extension'] ?></strong> - <?= $domain['price'] ?></li>
                        <?php endforeach; ?>
                    </ul>
                    <a href="paymnet.php" class="btn btn-primary">Register Now</a>
                </div>
            </div>
        </div>
    </div>
