...
<body>
	...
	<div class="plans mc-plans py-5">
		<div class="container">
            ...
            <?php 
    $hosting_setup = [
        'name' => 'Start Your Own Hosting Company',
        'setups' => [
            'Discord Server Setup',
            'Panel & Node Setup'
        ],
        'resources' => [
            '32GB VPS (AMD EPYC 7K62)',
            '.site Domain',
            'Nebula Theme'
        ],
        'guides' => [
        ...
        'custom_plans' => 'Custom Hosting Plans Available',
        'price' => '₹2500/month'
    ];
?>
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6">
            <div class="card text-center">
                <div class="card-body">
                    <h2><?= $hosting_setup['name'] ?></h2>
                    <ul>
                        <li><strong>Setups:</strong> <?= implode(', ', $hosting_setup['setups']) ?></li>
                        <li><strong>Resources:</strong> <?= implode(', ', $hosting_setup['resources']) ?></li>
                        <li><strong>Guides:</strong> <?= implode(', ', $hosting_setup['guides']) ?></li>
                        <li><strong>Custom Plans:</strong> <?= $hosting_setup['custom_plans'] ?></li>
                        <li><strong>Price:</strong> <?= $hosting_setup['price'] ?></li>
